							...
							<div class="row">
								<div class="col-xs-12 col-sm-4">
									<div class="cms-block">
										...
										<span>
											<img src="{{ theme('frontend/img/about/Seguinot-5_03.gif') }}" style="padding-left: 20px">
										</span>
										<span>
										...
										<span>
											<img src="{{ theme('frontend/img/about/Seguinot-5_07.png') }}" style="padding-left: 20px">
										</span>
									</div>
								</div>
								<div class="col-xs-12 col-sm-8">
									<div class="cms-box">
										...
										<img src="{{ theme('frontend/img/about/Seguinot-7_03.png') }}" style="padding-left: 20px">
										...
										<img src="{{ theme('frontend/img/about/Capture.png') }}" style="padding-left: 20px">
										...
										<img src="{{ theme('frontend/img/about/Seguinot-9_03.png') }}" style="padding-left: 20px">
									</div>
								</div>
								</div>
							</div>
