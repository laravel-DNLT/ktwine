				...
				<div id="center_column" class="col-md-9">
					...
					811
							...
							<div class="blog-image">
								<img src="{{ theme('frontend/img/leoblog/b/lg-b-blog-3.jpg') }}" title="Urna pretium elit mauris cursus Curabitur at elit Vestibulum"/>
							</div>
							...
							<div class="blog-tags">
								...
								<a href="../blog77cd.html?tag=Joomla" title="Joomla"><span>Joomla</span></a>
							...
							<div class="blog-comment-block">
								<div id="blog-localengine">
									...
									<form class="form-horizontal" method="post" id="comment-form" action="http://demo4leotheme.com/prestashop/leo_wine_store/en/blog/urna-pretium-elit-mauris-cursus-curabitur-at-elit-vestibulum-b5.html" onsubmit="return false;">
										...
										<div class="form-group">
											...
											<div class="col-lg-8 col-md-8 ipts-captcha">
												<img src="{{ theme('frontend/img/captcha/captcha-6.jpg') }}" class="comment-capcha-image" align="left"/>
