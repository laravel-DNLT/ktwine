...
<div class="breadcrumb clearfix">
	<a class="home" href="http://demo4leotheme.com/prestashop/leo_wine_store/" title="Return to Home">Home</a>
			<span class="navigation-pipe" >&gt;</span>
					<a href="../blog.html">Blog</a><span class="navigation-pipe">></span>Category 1
			</div>
<!-- /Breadcrumb -->
					</div>
				</div>
	...
	<div class="block_content products-block">
		...
		<ul class="products products-block">
            ...
            <div class="product-container media" itemscope itemtype="http://schema.org/Product">
                 <a class="products-block-image img pull-left" href="../home/9-donec-tellus-purus.html" title="Donec tellus purus"><img class="replace-2x img-responsive" src="{{ theme('frontend/img/products/donec-tellus-purus42small.jpg') }}" alt="Fusce a congue" />
                 </a>
...
<div id="viewed-products_block_left" class="block block-info nopadding">
	...
	<div class="comments_note product-rating" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
		...
		<span class="nb-comments"><span itemprop="reviewCount">0</span> Review(s)</span>
            ...
            <div class="product-container media" itemscope itemtype="http://schema.org/Product">
                 <a class="products-block-image img pull-left" href="../home/16-donec-tellus-purus.html" title="Fusce vestibulum"><img class="replace-2x img-responsive" src="{{ theme('frontend/img/products/donec-tellus-purus42Category 1small.jpg') }}" alt="Donec tellus purus" />
                 </a>
      ...
      <h4 class="title_block">Blog Categories</h4>
        <div class="block_content">
            <ul class="level1 tree dhtml ">
				<li id="list_3" class=" ">
					<a href="{{ url('blog/blog') }}" title="Category 1">
	    ...
	    <div id="blog-category" class="blogs-container">
				...
				<div class="panel-body">
							...
							<div class="category-image col-xs-12 col-sm-12 col-lg-4 text-center">
								<img src="{{ theme('frontend/modules/leoblog/img/c/category-3.jpg') }}" class="img-responsive" alt="" />
							</div>
			...
			<div class="row">
							<div class="col-lg-4">
										<img src="{{ theme('frontend/modules/leoblog/img/c/category-2.jpg') }}" class="img-responsive" alt=""/>
										<h4><a href="sub-category-1-c4.html" title="Sub Category 1">Sub Category 1</a></h4>
					<div class="child-desc"><p>Odio ut pretium ligula quam Vestibulum consequat convallis fringilla Vestibulum nulla. Accumsan morbi tristique auctor. At risus pretium urna tortor metus fringilla interdum mauris tempor congue</p></div>
				</div>
							<div class="col-lg-4">
										<img src="{{ theme('frontend/modules/leoblog/img/c/category-1.jpg') }}" class="img-responsive" alt=""/>
										<h4><a href="sub-category-2-c5.html" title="Sub Category 2">Sub Category 2</a></h4>
					<div class="child-desc"><p>Odio ut pretium ligula quam Vestibulum consequat convallis fringilla Vestibulum nulla. Accumsan morbi tristique auctor. At risus pretium urna tortor metus fringilla interdum mauris tempor congue</p></div>
				</div>
					</div>
