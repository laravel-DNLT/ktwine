...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <img src="{{theme('frontend/img/form/purchase-order.jpg')}}" width="100%">
            </div>
            <div class="col-md-12" style="padding: 10px 20px">
                <div class="col-md-4">
                    <img src="{{theme('frontend/img/form/purchase-order-1.jpg')}}" style="padding-left: 15px;padding-top: 25px">
                </div>
