	...
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation_page">Donec tellus purus</span>
			</div>
			<!-- /Breadcrumb -->
		</div>
	</div>
								...
								<div class="row">
									...
									<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
                                        ...
                                        <span id="view_full_size">
                                            <a class="jqzoom" title="Fusce vestibulum" rel="gal1" href="../39-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
												<img itemprop="image" src="{{ theme('frontend/') }}39-large_default/donec-tellus-purus.jpg" title="Fusce vestibulum" alt="Fusce vestibulum"/>
											</a>
                                        </span>
										</div>
										<!-- end image-block -->
											...
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_39" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/39-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/39-thickbox_default/donec-tellus-purus.jpg'}" title="Fusce vestibulum">
															<img class="img-responsive" id="thumb_39" src="{{ theme('frontend/') }}39-cart_default/donec-tellus-purus.jpg" alt="Fusce vestibulum" title="Fusce vestibulum" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div>
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
										...
										<p class="socialsharing_product no-print">
											<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Donec%20tellus%20purus%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/16-donec-tellus-purus.html');">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus39.jpg') }}" alt="Donec tellus purus" />
										...
										<p id="product_reference">
											<label>Model </label>
											<span class="editable" itemprop="sku">demo_16</span>
										</p>
										...
										<p id="pQuantityAvailable">
											<span id="quantityAvailable">342</span>
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/') }}39-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Donec tellus purus" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Donec tellus purus</strong>
															</p>
