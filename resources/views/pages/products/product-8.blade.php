...
<div id="center_column" class="col-md-12">
		...
		<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
			...
			<div id="image-block" class="clearfix">
						...
						<span class="new-label product-label">New</span>
													...
													<a class="jqzoom" title="Fusce vestibulum" rel="gal1" href="../38-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
								<img itemprop="image" src="{{ theme('frontend/') }}38-large_default/donec-tellus-purus.jpg" title="Fusce vestibulum" alt="Fusce vestibulum"/>
							</a>
											</span>
							</div> <!-- end image-block -->
							<!-- thumbnails -->
				<div id="views_block" class="clearfix ">
						...
						<ul id="thumbs_list_frame">
																																																						<li id="thumbnail_38">
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/38-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/38-thickbox_default/donec-tellus-purus.jpg'}" title="Fusce vestibulum">
										<img class="img-responsive" id="thumb_38" src="{{ theme('frontend/') }}38-cart_default/donec-tellus-purus.jpg" alt="Fusce vestibulum" title="Fusce vestibulum" height="112" width="81" itemprop="image" />
									</a>
								</li>
																																																<li id="thumbnail_55" class="last">
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/55-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/55-thickbox_default/donec-tellus-purus.jpg'}" title="Fusce vestibulum">
										<img class="img-responsive" id="thumb_55" src="{{ theme('frontend/') }}55-cart_default/donec-tellus-purus.jpg" alt="Fusce vestibulum" title="Fusce vestibulum" height="112" width="81" itemprop="image" />
									</a>
								</li>
																			</ul>
					</div> <!-- end thumbs_list -->
				...
				<!-- end thumbnails -->
					...
					<span id="wrapResetImages" style="display: none;">
						<a href="15-donec-tellus-purus.html" name="resetImages">
	...
	<p class="socialsharing_product no-print">
					<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Fusce%20vestibulum%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/15-donec-tellus-purus.html');">
		...
		<div id="send_friend_form">
			...
			<div class="row">
				<div class="product clearfix col-xs-12 col-sm-6">
					<img src="{{ theme('frontend/img/products/donec-tellus-purus38.jpg') }}" alt="Fusce vestibulum" />
				...
				<label>Model </label>
				<span class="editable" itemprop="sku">demo_15</span>
			</p>
				...
				<p id="pQuantityAvailable">
					<span id="quantityAvailable">3561</span>
...
<p class="buttons_bottom_block no-print">
	<a id="wishlist_button" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '15', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="Add to my wishlist">
		Add to my wishlist
	</a>
</p>
...
<div style="display: none;">
	<div id="new_comment_form">
		<form id="id_new_comment_form" action="#">
			...
			<div class="row">
																															<div class="product clearfix  col-xs-12 col-sm-6">
						<img src="{{ theme('frontend/') }}38-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Fusce vestibulum" />
						<div class="product_desc">
							<p class="product_name">
								<strong>Fusce vestibulum</strong>
							</p>
