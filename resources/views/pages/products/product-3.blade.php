								...
								<div class="row">
									...
									<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
                                        ...
                                        <span id="view_full_size">
                                            <a class="jqzoom" title="Donec tellus purus" rel="gal1" href="../33-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
												<img itemprop="image" src="{{ theme('frontend/img/products/donec-tellus-purus33big.jpg') }}" title="Donec tellus purus" alt="Donec tellus purus"/>
											</a>
                                        </span>
										</div>
										<!-- end image-block -->
										...
										<div id="views_block" class="clearfix ">
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_33">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/33-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/33-thickbox_default/donec-tellus-purus.jpg'}" title="Donec tellus purus">
															<img class="img-responsive" id="thumb_33" src="{{ theme('frontend/') }}33-cart_default/donec-tellus-purus.jpg" alt="Donec tellus purus" title="Donec tellus purus" height="112" width="81" itemprop="image" />
														</a>
													</li>
													<li id="thumbnail_48" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/48-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/48-thickbox_default/donec-tellus-purus.jpg'}" title="Donec tellus purus">
															<img class="img-responsive" id="thumb_48" src="{{ theme('frontend/') }}48-cart_default/donec-tellus-purus.jpg" alt="Donec tellus purus" title="Donec tellus purus" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div>
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus33.jpg') }}" alt="Donec tellus purus" />
										...
										<p id="product_reference">
											<label>Model </label>
											<span class="editable" itemprop="sku">demo_10</span>
										</p>
													...
													<div class="content_prices clearfix">
														...
														<div class="price">
															<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
																...
																<span id="our_price_display" itemprop="price">$323.00</span>
																<!---->
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/') }}33-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Donec tellus purus" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Donec tellus purus</strong>
															</p>
