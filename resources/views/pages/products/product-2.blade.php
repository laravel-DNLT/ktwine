	...
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation-pipe">></span>Fusce a congue
								...
								<div class="row">
									...
									<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
                                        ...
                                        <span id="view_full_size">
                                            <a class="jqzoom" title="Donec tellus purus" rel="gal1" href="../31-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
												<img itemprop="image" src="{{ theme('frontend/img') }}31-large_default/donec-tellus-purus.jpg" title="Donec tellus purus" alt="Donec tellus purus"/>
											</a>
                                        </span>
										</div>
										<!-- end image-block -->
										...
										<div id="views_block" class="clearfix ">
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_30">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/30-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/30-thickbox_default/donec-tellus-purus.jpg'}" title="Donec tellus purus">
															<img class="img-responsive" id="thumb_30" src="{{ theme('frontend/img') }}30-cart_default/donec-tellus-purus.jpg" alt="Donec tellus purus" title="Donec tellus purus" height="112" width="81" itemprop="image" />
														</a>
													</li>
													<li id="thumbnail_31">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/31-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/31-thickbox_default/donec-tellus-purus.jpg'}" title="Donec tellus purus">
															<img class="img-responsive" id="thumb_31" src="{{ theme('frontend/img') }}31-cart_default/donec-tellus-purus.jpg" alt="Donec tellus purus" title="Donec tellus purus" height="112" width="81" itemprop="image" />
														</a>
													</li>
													<li id="thumbnail_32" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/32-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/32-thickbox_default/donec-tellus-purus.jpg'}" title="Donec tellus purus">
															<img class="img-responsive" id="thumb_32" src="img/products/donec-tellus-purus32small.jpg" alt="Donec tellus purus" title="Donec tellus purus" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div>
                                        ...
                                        <span id="wrapResetImages" style="display: none;">
                                            <a href="9-donec-tellus-purus.html" name="resetImages">
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
										<h1 itemprop="name">Fusce a congue</h1>
										<p class="socialsharing_product no-print">
											<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Fusce%20a%20congue%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/9-donec-tellus-purus.html');">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus31.jpg') }}" alt="Fusce a congue" />
																<div class="product_desc">
																	<p class="product_name">
																		<strong>Fusce a congue</strong>
																	</p>
										...
										<p id="product_reference">
											<label>Model </label>
											<span class="editable" itemprop="sku">demo_9</span>
										</p>
										...
										<p id="pQuantityAvailable">
											<span id="quantityAvailable">1966</span>
													...
													<div class="content_prices clearfix">
														...
														<div class="price">
															<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
																...
																<span id="our_price_display" itemprop="price">$167.91</span>
																<!---->
										...
										-13%									</span>
															...
															<p id="old_price">
																<span id="old_price_display">$193.00</span>
																<!--  -->
															</p>
														</div>
														<!-- end prices -->
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/img/') }}31-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Fusce a congue" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Fusce a congue</strong>
															</p>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-4') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-4') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
