								...
								<div class="row">
									...
									<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
                                        ...
                                        <span id="view_full_size">
                                            <a class="jqzoom" title="Ligula ullamcorper" rel="gal1" href="../41-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
												<img itemprop="image" src="{{ theme('frontend/img/products/donec-tellus-purus41.jpg') }}" title="Ligula ullamcorper" alt="Ligula ullamcorper"/>
											</a>
                                        </span>
										</div>
										<!-- end image-block -->
											...
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_41" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/41-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/41-thickbox_default/donec-tellus-purus.jpg'}" title="Ligula ullamcorper">
															<img class="img-responsive" id="thumb_41" src="{{ theme('frontend/') }}41-cart_default/donec-tellus-purus.jpg" alt="Ligula ullamcorper" title="Ligula ullamcorper" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div>
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
										...
										<p class="socialsharing_product no-print">
											<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Ligula%20ullamcorper%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/18-donec-tellus-purus.html');">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus41.jpg') }}" alt="Ligula ullamcorper" />
										...
										<p id="product_reference">
											<label>Model </label>
											<span class="editable" itemprop="sku">demo_18</span>
										</p>
										...
										<p id="pQuantityAvailable">
											<span id="quantityAvailable">3451</span>
										...
										-5%									</span>
													...
													<p class="buttons_bottom_block no-print">
														<a id="wishlist_button" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '18', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="Add to my wishlist">
															Add to my wishlist
														</a>
													</p>
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/') }}41-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Ligula ullamcorper" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Ligula ullamcorper</strong>
															</p>
