	...
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation_page">Mattis augue</span>
			</div>
			<!-- /Breadcrumb -->
		</div>
	</div>
								...
								<div class="row">
									...
									<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
                                        ...
                                        <span id="view_full_size">
                                            <a class="jqzoom" title="Mattis augue" rel="gal1" href="../42-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
												<img itemprop="image" src="{{ theme('frontend/img/products/donec-tellus-purus42.jpg') }}" title="Mattis augue" alt="Mattis augue"/>
											</a>
                                        </span>
										</div>
										<!-- end image-block -->
											...
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_42" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/42-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/42-thickbox_default/donec-tellus-purus.jpg'}" title="Mattis augue">
															<img class="img-responsive" id="thumb_42" src="{{ theme('frontend/') }}42-cart_default/donec-tellus-purus.jpg" alt="Mattis augue" title="Mattis augue" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div>
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
										<h1 itemprop="name">Mattis augue</h1>
										<p class="socialsharing_product no-print">
											<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Mattis%20augue%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/19-donec-tellus-purus.html');">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus42.jpg') }}" alt="Mattis augue" />
																<div class="product_desc">
																	<p class="product_name">
																		<strong>Mattis augue</strong>
																	</p>
										...
										<p id="product_reference">
											<label>Model </label>
											<span class="editable" itemprop="sku">demo_19</span>
										</p>
										...
										<p id="pQuantityAvailable">
											<span id="quantityAvailable">3452</span>
													...
													<div class="content_prices clearfix">
														...
														<div class="price">
															<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
																...
																<span id="our_price_display" itemprop="price">$223.25</span>
																<!---->
										...
										-5%									</span>
													...
													<p class="buttons_bottom_block no-print">
														<a id="wishlist_button" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '19', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="Add to my wishlist">
															Add to my wishlist
														</a>
													</p>
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/') }}42-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Mattis augue" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Mattis augue</strong>
															</p>
							...
							$223.25						</span>
								...
								$235.00
																	...
																	<div class="functional-buttons clearfix">
																		...
																		<a class="compare add_to_compare compare btn btn-default btn-outline-inverse" href="{{ url('product-11') }}" d{{ url('product-11') }}ata-id-product="18" title="Add to compare" >
																			<i class="fa fa-retweet"></i>
																			<span>Add to compare</span>
																		</a>
