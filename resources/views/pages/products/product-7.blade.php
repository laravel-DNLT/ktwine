	...
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation_page">Fusce vestibulum</span>
			</div>
			<!-- /Breadcrumb -->
		</div>
	</div>
								...
								<div class="row">
									...
									<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
                                        ...
                                        <span id="view_full_size">
                                            <a class="jqzoom" title="Lorem ipsum dolor" rel="gal1" href="../37-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
												<img itemprop="image" src="{{ theme('frontend/') }}37-large_default/donec-tellus-purus.jpg" title="Lorem ipsum dolor" alt="Lorem ipsum dolor"/>
											</a>
                                        </span>
										</div>
										<!-- end image-block -->
										...
										<div id="views_block" class="clearfix ">
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_37">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/37-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/37-thickbox_default/donec-tellus-purus.jpg'}" title="Lorem ipsum dolor">
															<img class="img-responsive" id="thumb_37" src="{{ theme('frontend/') }}37-cart_default/donec-tellus-purus.jpg" alt="Lorem ipsum dolor" title="Lorem ipsum dolor" height="112" width="81" itemprop="image" />
														</a>
													</li>
													<li id="thumbnail_52" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/52-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/52-thickbox_default/donec-tellus-purus.jpg'}" title="Fusce vestibulum">
															<img class="img-responsive" id="thumb_52" src="{{ theme('frontend/') }}52-cart_default/donec-tellus-purus.jpg" alt="Fusce vestibulum" title="Fusce vestibulum" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div>
                                        ...
                                        <span id="wrapResetImages" style="display: none;">
                                            <a href="14-donec-tellus-purus.html" name="resetImages">
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
										<h1 itemprop="name">Fusce vestibulum</h1>
										<p class="socialsharing_product no-print">
											<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Fusce%20vestibulum%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/14-donec-tellus-purus.html');">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus37.jpg') }}" alt="Fusce vestibulum" />
																<div class="product_desc">
																	<p class="product_name">
																		<strong>Fusce vestibulum</strong>
																	</p>
										...
										<p id="product_reference">
											<label>Model </label>
											<span class="editable" itemprop="sku">demo_14</span>
										</p>
										...
										<p id="pQuantityAvailable">
											<span id="quantityAvailable">327</span>
											...
											<form id="buy_block" action="http://demo4leotheme.com/prestashop/leo_wine_store/en/cart" method="post">
												...
												<div class="box-info-product">
													<div class="content_prices clearfix">
														...
														<div class="price">
															<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
																...
																<span id="our_price_display" itemprop="price">$423.00</span>
																<!---->
													...
													<p class="buttons_bottom_block no-print">
														<a id="wishlist_button" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '14', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="Add to my wishlist">
															Add to my wishlist
														</a>
													</p>
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/') }}37-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Fusce vestibulum" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Fusce vestibulum</strong>
															</p>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-6') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-6') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-10') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-10') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-11') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-11') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-12') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-12') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
