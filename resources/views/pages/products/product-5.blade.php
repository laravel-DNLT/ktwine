	...
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation_page">Morbi ullamcorper</span>
			</div>
			<!-- /Breadcrumb -->
		</div>
	</div>
				...
				<div id="center_column" class="col-md-12">
					<div class="clearfix">
						...
						<span class="new-label product-label">New</span>
													...
													<a class="jqzoom" title="Donec tellus purus" rel="gal1" href="../35-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
														<img itemprop="image" src="{{ theme('frontend/') }}35-large_default/donec-tellus-purus.jpg" title="Donec tellus purus" alt="Donec tellus purus"/>
													</a>
											</span>
										</div> <!-- end image-block -->
										<!-- thumbnails -->
										<div id="views_block" class="clearfix ">
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_35">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/35-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/35-thickbox_default/donec-tellus-purus.jpg'}" title="Donec tellus purus">
															<img class="img-responsive" id="thumb_35" src="{{ theme('frontend/') }}35-cart_default/donec-tellus-purus.jpg" alt="Donec tellus purus" title="Donec tellus purus" height="112" width="81" itemprop="image" />
														</a>
													</li>
													<li id="thumbnail_50" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/50-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/50-thickbox_default/donec-tellus-purus.jpg'}" title="Morbi ullamcorper">
															<img class="img-responsive" id="thumb_50" src="{{ theme('frontend/') }}50-cart_default/donec-tellus-purus.jpg" alt="Morbi ullamcorper" title="Morbi ullamcorper" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div> <!-- end thumbs_list -->
					...
					<span id="wrapResetImages" style="display: none;">
						<a href="12-donec-tellus-purus.html" name="resetImages">
							...
							Display all pictures
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
										...
										<h1 itemprop="name">Morbi ullamcorper</h1>
										<p class="socialsharing_product no-print">
											<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Morbi%20ullamcorper%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/12-donec-tellus-purus.html');">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus35.jpg') }}" alt="Morbi ullamcorper" />
																<div class="product_desc">
																	<p class="product_name">
																		<strong>Morbi ullamcorper</strong>
																	</p>
										...
										<p id="product_reference">
											<label>Model </label>
											<span class="editable" itemprop="sku">demo_12</span>
										</p>
										...
										<p id="pQuantityAvailable">
											<span id="quantityAvailable">224</span>
													...
													<div class="content_prices clearfix">
														...
														<div class="price">
															<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
																<link itemprop="availability" href="http://schema.org/InStock"/>																			<span id="our_price_display" itemprop="price">$238.00</span>
																<!---->
									...
									<span id="reduction_amount_display">
													...
													<p class="buttons_bottom_block no-print">
														<a id="wishlist_button" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '12', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="Add to my wishlist">
															Add to my wishlist
														</a>
													</p>
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/') }}35-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Morbi ullamcorper" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Morbi ullamcorper</strong>
															</p>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-7') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-7') }}" title="Quick view" >
																	</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-8') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-8') }}" title="Quick view" >
																	</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-9') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-9') }}" title="Quick view" >
																	</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="17-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/17-donec-tellus-purus.html" title="Quick view" >
																	</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="18-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/18-donec-tellus-purus.html" title="Quick view" >
																	</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="19-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/19-donec-tellus-purus.html" title="Quick view" >
																	</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
