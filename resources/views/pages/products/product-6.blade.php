	...
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation_page">Lorem ipsum dolor</span>
			</div>
			<!-- /Breadcrumb -->
		</div>
	</div>
								...
								<div class="row">
									...
									<div class="pb-left-column col-xs-12 col-sm-5 col-md-5">
                                        ...
                                        <span id="view_full_size">
                                            <a class="jqzoom" title="Morbi ullamcorper" rel="gal1" href="../36-thickbox_default/donec-tellus-purus.jpg" itemprop="url">
												<img itemprop="image" src="{{ theme('frontend/') }}36-large_default/donec-tellus-purus.jpg" title="Morbi ullamcorper" alt="Morbi ullamcorper"/>
											</a>
                                        </span>
										</div>
										<!-- end image-block -->
										...
										<div id="views_block" class="clearfix ">
											<div id="thumbs_list">
												<ul id="thumbs_list_frame">
													<li id="thumbnail_36">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/36-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/36-thickbox_default/donec-tellus-purus.jpg'}" title="Morbi ullamcorper">
															<img class="img-responsive" id="thumb_36" src="{{ theme('frontend/') }}36-cart_default/donec-tellus-purus.jpg" alt="Morbi ullamcorper" title="Morbi ullamcorper" height="112" width="81" itemprop="image" />
														</a>
													</li>
													<li id="thumbnail_53" class="last">
														<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/53-large_default/donec-tellus-purus.jpg',largeimage: 'http://demo4leotheme.com/prestashop/leo_wine_store/53-thickbox_default/donec-tellus-purus.jpg'}" title="Lorem ipsum dolor">
															<img class="img-responsive" id="thumb_53" src="{{ theme('frontend/') }}53-cart_default/donec-tellus-purus.jpg" alt="Lorem ipsum dolor" title="Lorem ipsum dolor" height="112" width="81" itemprop="image" />
														</a>
													</li>
												</ul>
											</div>
                                        ...
                                        <span id="wrapResetImages" style="display: none;">
                                            <a href="13-donec-tellus-purus.html" name="resetImages">
									...
									<div class="pb-center-column col-xs-12 col-sm-7 col-md-7">
										<h1 itemprop="name">Lorem ipsum dolor</h1>
										<p class="socialsharing_product no-print">
											<button type="button" class="btn btn-default btn-twitter" onclick="socialsharing_twitter_click('Lorem%20ipsum%20dolor%20http_/demo4leotheme.com/prestashop/leo_wine_store/en/champagne/13-donec-tellus-purus.html');">
													...
													<div id="send_friend_form">
														...
														<div class="row">
															<div class="product clearfix col-xs-12 col-sm-6">
																<img src="{{ theme('frontend/img/products/donec-tellus-purus36.jpg') }}" alt="Lorem ipsum dolor" />
										...
										<p id="pQuantityAvailable">
											<span id="quantityAvailable">4541</span>
											...
											<form id="buy_block" action="http://demo4leotheme.com/prestashop/leo_wine_store/en/cart" method="post">
												...
												<div class="box-info-product">
													<div class="content_prices clearfix">
														...
														<div class="price">
															<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
																...
																<span id="our_price_display" itemprop="price">$545.00</span>
																<!---->
													...
													<p class="buttons_bottom_block no-print">
														<a id="wishlist_button" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '13', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="Add to my wishlist">
															Add to my wishlist
														</a>
													</p>
									...
									<div style="display: none;">
										<div id="new_comment_form">
											<form id="id_new_comment_form" action="#">
												...
												<div class="row">
													<div class="product clearfix  col-xs-12 col-sm-6">
														<img src="{{ theme('frontend/') }}36-medium_default/donec-tellus-purus.jpg" height="178" width="125" alt="Lorem ipsum dolor" />
														<div class="product_desc">
															<p class="product_name">
																<strong>Lorem ipsum dolor</strong>
															</p>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-5') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-5') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-7') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-7') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
                                                                <span class="sale-box">
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-8') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-8') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="quick-view btn-outline btn" href="{{ url('product-9') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/{{ url('product-9') }}" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="product_img_link"	href="17-donec-tellus-purus.html" title="Ligula ullamcorper" itemprop="url">
																	...
																	<a class="quick-view btn-outline btn" href="17-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/17-donec-tellus-purus.html" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
															...
															<div class="right-block">
																<div class="product-meta">
																	<h5 itemprop="name" class="name">
																		<a class="product-name" href="17-donec-tellus-purus.html" title="Ligula ullamcorper" itemprop="url" >
																			Ligula ullamcorper
																		</a>
																	</h5>
																	<p class="product-desc" itemprop="description">
							...
							$223.25						</span>
								...
								$235.00
																	...
																	<div class="functional-buttons clearfix">
																		...
																		<a class="compare add_to_compare compare btn btn-default btn-outline-inverse" href="17-donec-tellus-purus.html" data-id-product="17" title="Add to compare" >
																			<i class="fa fa-retweet"></i>
																			<span>Add to compare</span>
																		</a>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="product_img_link"	href="18-donec-tellus-purus.html" title="Ligula ullamcorper" itemprop="url">
																	...
																	<a class="quick-view btn-outline btn" href="18-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/18-donec-tellus-purus.html" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
															...
															<div class="right-block">
																<div class="product-meta">
																	<h5 itemprop="name" class="name">
																		<a class="product-name" href="18-donec-tellus-purus.html" title="Ligula ullamcorper" itemprop="url" >
																			Ligula ullamcorper
																		</a>
																	</h5>
																	<p class="product-desc" itemprop="description">
							...
							$223.25						</span>
								...
								$235.00
																	...
																	<div class="functional-buttons clearfix">
																		...
																		<a class="compare add_to_compare compare btn btn-default btn-outline-inverse" href="18-donec-tellus-purus.html" data-id-product="18" title="Add to compare" >
																			<i class="fa fa-retweet"></i>
																			<span>Add to compare</span>
																		</a>
														...
														<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
															<div class="left-block">
																<div class="product-image-container image">
																	...
																	<a class="product_img_link"	href="19-donec-tellus-purus.html" title="Mattis augue" itemprop="url">
																	...
																	<a class="quick-view btn-outline btn" href="19-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/19-donec-tellus-purus.html" title="Quick view" ></a>
                                                                <span class="new-box">
                                                                    <span class="new-label product-label">New</span>
                                                                </span>
																</div>
															...
															<div class="right-block">
																<div class="product-meta">
																	<h5 itemprop="name" class="name">
																		<a class="product-name" href="19-donec-tellus-purus.html" title="Mattis augue" itemprop="url" >
																			Mattis augue
																		</a>
																	</h5>
																	<p class="product-desc" itemprop="description">
							...
							$223.25						</span>
								...
								$235.00
																	...
																	<div class="functional-buttons clearfix">
																		...
																		<a class="compare add_to_compare compare btn btn-default btn-outline-inverse" href="19-donec-tellus-purus.html" data-id-product="19" title="Add to compare" >
																			<i class="fa fa-retweet"></i>
																			<span>Add to compare</span>
																		</a>
