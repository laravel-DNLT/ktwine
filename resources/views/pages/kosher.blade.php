								...
								<li class="clearfix media">
									...
									<div class="product-block">
										...
										<div class="product-container media" itemscope itemtype="http://schema.org/Product">
											<a class="products-block-image img pull-left" href="home/9-donec-tellus-purus.html" title="Donec tellus purus"><img class="replace-2x img-responsive" src="{{ theme('frontend/img/product/donec-tellus-purus31small.jpg') }}" alt="Fusce a congue" />
											</a>
					...
					<div class="clearfix">
						...
						<div class="content_scene_cat">
							...
							<div class="content_scene_cat_bg scene_cat">
								<div class="image">
									<img class="img-responsive" src="{{ theme('frontend/../c/14-category_default/kosher.jpg') }}" alt="Kosher" title="Kosher" id="categoryImage"  />
								</div>
								<div class="cat-desc">
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="quick-view btn-outline btn" href="home/11-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/home/11-donec-tellus-purus.html" title="Quick view" >
											</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="quick-view btn-outline btn" href="home/12-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/home/12-donec-tellus-purus.html" title="Quick view" >
											</a>
										<span class="new-box">
					<span class="new-label product-label">New</span>
				</span>
