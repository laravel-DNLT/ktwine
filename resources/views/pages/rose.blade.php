	...
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation_page">Rose</span>
			</div>
			<!-- /Breadcrumb -->
		</div>
	</div>
					...
					<div id="categories_block_left" class="block nopadding">
						...
						<div class="block_content">
							<ul class="list-block bullet tree dhtml">
								...
								{{--</li>--}}
								<li >
									<a href="{{ url('rose') }}" class="selected" title="Rose">
										Rose
					...
					<div class="clearfix">
						<div class="content_scene_cat">
							...
							<div class="content_scene_cat_bg scene_cat">
								<div class="image">
									<img class="img-responsive" src="{{ theme('frontend/img/rose.jpg') }}" alt="Rose" title="Rose" id="categoryImage"  />
								</div>
								<div class="cat-desc">
									<div class="rte">
										<p>When we launched the first boutique portfolio of Argentine wines in 1999, we never imagined we’d be at the forefront of a wine revolution that would someday have Mendoza on the lips of wine drinkers across the US. Since then, we have been fortunate to lead the charge on Japanese ginjo sake and Argentina’s northern region of Salta.</p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="clearfix">
								<div class="col-md-3 col-xs-6 col-sp-12">
									<div class="subcategories scene_cat">
										<div class="image">
											<a href="22-boxwine-.html" title="Boxwine " class="img">
												<img class="replace-2x img-responsive" src="{{ theme('frontend/img/boxwine-.jpg') }}" alt=""/>
											</a>
										</div>
										<h5 class="cat-name" >
											<a href="22-boxwine-.html">Boxwine</a>
										</h5>
										<div class="cat-desc">
											<p>When we launched the first boutique portfolio of Argentine wines in 1999, we never imagined we’d be at the forefront of a wine revolution that would someday have Mendoza on the lips of wine drinkers across the US.</p>
										</div>
									</div>
								</div>
								<div class="col-md-3 col-xs-6 col-sp-12">
									<div class="subcategories scene_cat">
										<div class="image">
											<a href="23-broadbent.html" title="Broadbent" class="img">
												<img class="replace-2x img-responsive" src="{{ theme('frontend/img/broadbent.jpg') }}" alt=""/>
											</a>
										</div>
										<h5 class="cat-name" >
											<a href="23-broadbent.html">Broadbent</a>
										</h5>
										<div class="cat-desc">
											<p>Since then, we have been fortunate to lead the charge on Japanese ginjo sake and Argentina’s northern region of Salta.</p>
										</div>
									</div>
								</div>
								<div class="col-md-3 col-xs-6 col-sp-12">
									<div class="subcategories scene_cat">
										<div class="image">
											<a href="24-finca-las-nubes.html" title="Finca Las Nubes" class="img">
												<img class="replace-2x img-responsive" src="{{ theme('frontend/img/finca-las-nubes.jpg') }}" alt=""/>
											</a>
										</div>
										<h5 class="cat-name" >
											<a href="24-finca-las-nubes.html">Finca Las Nubes</a>
										</h5>
										<div class="cat-desc">
											<p>When we launched the first boutique portfolio of Argentine wines in 1999, we never imagined we’d be at the forefront of a wine revolution that would someday have Mendoza</p>
										</div>
									</div>
								</div>
								<div class="col-md-3 col-xs-6 col-sp-12">
									<div class="subcategories scene_cat">
										<div class="image">
											<a href="25-ichanka.html" title="Ichanka" class="img">
												<img class="replace-2x img-responsive" src="{{ theme('frontend/img/ichanka.jpg') }}" alt=""/>
											</a>
										</div>
										<h5 class="cat-name" >
											<a href="25-ichanka.html">Ichanka</a>
										</h5>
										<div class="cat-desc">
											<p>When we launched the first boutique portfolio of Argentine wines in 1999, we never imagined we’d be at the forefront of a wine revolution that would someday have Mendoza</p>
										</div>
							...
							<div class="sortPagiBar clearfix row">
								<div class="col-md-10 col-sm-8 col-xs-6">
									<div class="sort">
										...
										<form id="productsSortForm" action="http://demo4leotheme.com/prestashop/leo_wine_store/en/16-rose" class="productsSortForm form-horizontal pull-left hidden-xs ">
											<div class="select">
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="product_img_link"	href="champagne/10-donec-tellus-purus.html" title="Donec tellus purus" itemprop="url">
											...
											<a class="quick-view btn-outline btn" href="champagne/10-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/10-donec-tellus-purus.html" title="Quick view" ></a>
                                    <span class="new-box">
									...
									<div class="right-block">
										<div class="product-meta">
											<h5 itemprop="name" class="name">
												<a class="product-name" href="champagne/10-donec-tellus-purus.html" title="Donec tellus purus" itemprop="url" >
													Donec tellus purus
												</a>
											</h5>
							...
							$323.00						</span>
                                        ...
                                        <span class="available-now">
											...
											<div class="functional-buttons clearfix">
												...
												<a class="compare add_to_compare compare btn btn-default btn-outline-inverse" href="champagne/10-donec-tellus-purus.html" data-id-product="10" title="Add to compare" >
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="product_img_link"	href="champagne/11-donec-tellus-purus.html" title="Donec tellus purus" itemprop="url">
											...
											<a class="quick-view btn-outline btn" href="champagne/11-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/11-donec-tellus-purus.html" title="Quick view" ></a>
                                    <span class="new-box">
                                        <span class="new-label product-label">New</span>
                                    </span>
										</div>
									...
									<div class="right-block">
										<div class="product-meta">
											<h5 itemprop="name" class="name">
												<a class="product-name" href="champagne/11-donec-tellus-purus.html" title="Donec tellus purus" itemprop="url" >
													Donec tellus purus
												</a>
											</h5>
											<p class="product-desc" itemprop="description">
							...
							$243.00						</span>
                                        ...
                                        <span class="available-now">
											...
											<div class="functional-buttons clearfix">
												...
												<a class="compare add_to_compare compare btn btn-default btn-outline-inverse" href="champagne/11-donec-tellus-purus.html" data-id-product="11" title="Add to compare" >
													<i class="fa fa-retweet"></i>
													<span>Add to compare</span>
												</a>
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="quick-view btn-outline btn" href="home/13-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/13-donec-tellus-purus.html" title="Quick view" ></a>
                                    <span class="new-box">
                                        <span class="new-label product-label">New</span>
                                    </span>
										</div>
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="quick-view btn-outline btn" href="home/16-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/16-donec-tellus-purus.html" title="Quick view" ></a>
                                    <span class="new-box">
                                        <span class="new-label product-label">New</span>
                                    </span>
										</div>
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="quick-view btn-outline btn" href="home/17-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/17-donec-tellus-purus.html" title="Quick view" ></a>
                                    <span class="new-box">
                                        <span class="new-label product-label">New</span>
                                    </span>
										</div>
								...
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="quick-view btn-outline btn" href="home/18-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/18-donec-tellus-purus.html" title="Quick view" ></a>
                                    <span class="new-box">
                                        <span class="new-label product-label">New</span>
                                    </span>
										</div>
				 ...
				 last-mobile-line">
								<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image">
											...
											<a class="quick-view btn-outline btn" href="home/19-donec-tellus-purus.html" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/champagne/19-donec-tellus-purus.html" title="Quick view" ></a>
                                    <span class="new-box">
                                        <span class="new-label product-label">New</span>
                                    </span>
										</div>
						...
						<div class="content_sortPagiBar">
							<div class="bottom-pagination-content clearfix row">
								<div class="col-md-10 col-sm-8 col-xs-6">
									<!-- Pagination -->
									<div id="pagination_bottom" class="pagination clearfix pull-left"></div>
